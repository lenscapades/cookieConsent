...
class CookieConsent {
	...
	private function define_generic_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_generic, 'register_shortcodes' );
		$this->loader->add_action( 'the_title', $plugin_generic, 'set_title', 10, 1 );
		...
		$this->loader->add_action( 'locale', $plugin_generic, 'set_locale', 10 );
